...
/* Pin connection*/
#define ST7789_RST_PORT NOTHING 
#define ST7789_RST_PIN  spi0_rst
#define ST7789_DC_PORT  NOTHING
#define ST7789_DC_PIN   spi0_cmd

#define ST7789_CS_PORT  NOTHING
#define ST7789_CS_PIN   NOTHING
...
/* Basic operations */
#define ST7789_RST_Clr() gpio_set_value(spi0_rst,0)
#define ST7789_RST_Set() gpio_set_value(spi0_rst,1)

#define ST7789_DC_Clr() gpio_set_value(spi0_cmd,0)
#define ST7789_DC_Set() gpio_set_value(spi0_cmd,1)

#define HAL_SPI_Transmit(spi,data,len,timeout) ili9255_write_regs(data,len)
/*
...
/* Basic functions. */
void ST7789_Init(struct spi_device * spi_st7789 , unsigned cmd_gpio , unsigned rst_gpio);
