...
// #endif
    ...
    #define NOTHING 0x00
	#define	CSX_PORT	NOTHING
    #define CSX_PIN		NOTHING
	#define RESX_PORT	NOTHING

	#define	CMD_PORT	NOTHING

    #define GPIO_PIN_RESET 0
    #define GPIO_PIN_SET 1
    #define HAL_GPIO_WritePin(port,gpio,value) gpio_set_value(gpio,value)
    #define HAL_SPI_Transmit(spi_device, data,len,timeout) ili9255_write_onereg(data,len)
    ...
    void spi_write_ili9255(unsigned char data);
    void lcd_write_command(unsigned char data);
    void lcd_write_data(unsigned char data);
    void lcd_write_register(unsigned int reg, unsigned int data);
    void lcd_init(struct spi_device * spi_lcd,unsigned cmd_gpio,unsigned rest_gpio);
